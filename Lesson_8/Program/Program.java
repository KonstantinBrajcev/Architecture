...
public class Program {
    ...
    // void changeReservationTable(int tableNumber, Date date, int numberOfPersons,
    ...
    // @Override
    // public void changeReservationTable(int tableNumber, Date date, int
    // numberOfPersons, String reservationName) {
    // model.changeReservationTable(tableNumber, date, numberOfPersons,
    // reservationName);
    // }
    // }
