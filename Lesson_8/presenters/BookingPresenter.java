...
public class BookingPresenter implements ViewObserver {
  ...
  public void onCancelReservation(int reservationId) {
    // В текущей реализации просто игнорируем отмену, так как изменение брони
    // обрабатывается в TableModel.changeReservationTable
    // В реальном приложении здесь можно добавить логику подтверждения отмены
    System.out.println("Отмена брони #" + reservationId);
  }
}