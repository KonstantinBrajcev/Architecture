...
public interface View {
  ...
  /**
   * Метод позволяет установить наблюдателя, отслеживающего действия конечного
   * пользователя
   * 
   * @param observer
   */
  ...
  void changeReservationTable(int oldReservationId, Date reservationDate, int tableNo, String name);
}